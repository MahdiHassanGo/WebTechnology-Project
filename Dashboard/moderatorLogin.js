...
function login(){
  ...
  if(user !== "moderator" || pass !== "mod12345") return setMsg("Invalid moderator credentials.", ""), null

  saveSession({ role: "moderator", username: "moderator" })
  setMsg("", "Moderator login successful! Redirecting...")
  setTimeout(()=>{ window.location.href = "moderatorDashboard.html" }, 600)
}
